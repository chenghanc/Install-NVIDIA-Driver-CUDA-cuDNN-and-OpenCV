...
if __name__ == "__main__":
    ...
    engine_file_path = "build/v7m.engine"
    ...
    categories = ["blue", "yellow", "white", "red", "AdultHead", "RealBabyHead"]
    ...
    try:
        ...
        image_dir = "../../../helmet2020-1-production082021/18Photocannotbefiltered/"
